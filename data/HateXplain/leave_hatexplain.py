...
from data.HateXplain.leave_hatexplain_config import TEMP_DIRECTORY, MODEL_TYPE, MODEL_NAME, args, SEED
...
train = pd.concat([davidson_train, hasoc_train, hatexplain_train, ohc_train, olid_train, tcc_train, trac_train], ignore_index=True)
...
model = ClassificationModel(MODEL_TYPE, MODEL_NAME, args=args,
                            ...
                            cuda_device=1)  # You can set class weights by using the optional weight argument
