...
from data.DAVIDSON.leave_davidson_config import TEMP_DIRECTORY, MODEL_TYPE, MODEL_NAME, args, SEED
...
train = pd.concat([hasoc_train, hateval_train, hatexplain_train, ohc_train, olid_train, tcc_train, trac_train], ignore_index=True)
